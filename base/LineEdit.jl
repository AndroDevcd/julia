...
struct type ModalInterface <: TextInterface
    modes
end

mutable type MIState
...
mutable type Prompt <: TextInterface
    prompt
...
struct type InputAreaState
    num_rows::Int64
    curs_row::Int64
end

mutable type PromptState <: ModeState
    terminal
    p::Prompt
...
mutable type EmptyCompletionProvider <: CompletionProvider
end

mutable type EmptyHistoryProvider <: HistoryProvider
end
...
mutable type SearchState <: ModeState
    terminal
    histprompt
...
mutable type HistoryPrompt{T<:HistoryProvider} <: TextInterface
    hp::T
    complete
...
mutable type PrefixSearchState <: ModeState
    terminal
    histprompt
    prefix::String
    response_buffer::IOBuffer
...
mutable type PrefixHistoryPrompt{T<:HistoryProvider} <: TextInterface
    hp::T
