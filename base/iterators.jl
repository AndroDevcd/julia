...
struct type Zip1{I} <: AbstractZipIterator
    a::I
end
zip(a) = Zip1(a)
...
struct type Zip2{I1, I2} <: AbstractZipIterator
    a::I1
    b::I2
end
zip(a, b) = Zip2(a, b)
...
struct type Zip{I, Z<:AbstractZipIterator} <: AbstractZipIterator
    a::I
    z::Z
end
...
# one iterator
struct type Prod1{I} <: AbstractProdIterator
    a::I
end
product(a) = Prod1(a)
...
# two iterators
struct type Prod2{I1, I2} <: AbstractProdIterator
    a::I1
    b::I2
end
...
# n iterators
struct type Prod{I1, I2<:AbstractProdIterator} <: AbstractProdIterator
    a::I1
    b::I2
end
...
mutable type PartitionIterator{T}
    c::T
    n::Int
end
