...
mutable type TCPSocket <: LibuvStream
    handle::Ptr{Void}
    status::Int
    buffer::IOBuffer
...
mutable type TCPServer <: LibuvServer
    handle::Ptr{Void}
    status::Int
    connectnotify::Condition
    closenotify::Condition
...
mutable type UDPSocket <: LibuvStream
    handle::Ptr{Void}
    status::Int
...
mutable type DNSError <: Exception
    host::AbstractString
    code::Int32
end
