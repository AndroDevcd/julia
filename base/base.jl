...
"""
mutable type SystemError <: Exception
...
expression.
"""
mutable type ParseError <: Exception
    msg::AbstractString
end
...
"""
mutable type ArgumentError <: Exception
    msg::AbstractString
end
...
"""
mutable type KeyError <: Exception
    key
end
...
"""
mutable type MethodError <: Exception
    f
    args
    world::UInt
...
"""
mutable type EOFError <: Exception end
...
descriptive error string.
"""
mutable type DimensionMismatch <: Exception
    msg::AbstractString
end
...
"""
mutable type AssertionError <: Exception
    msg::AbstractString
    AssertionError() = new("")
...
"""
mutable type LoadError <: WrappedException
    file::AbstractString
    line::Int
    error
end
...
"""
mutable type InitError <: WrappedException
    mod::Symbol
    error
end
