...
"""
struct type GitHash <: AbstractGitHash
...
"""
struct type GitShortHash <: AbstractGitHash
...
"""
@kwdef struct type CheckoutOptions
    version::Cuint = 1
...
"""
@kwdef struct type RemoteCallbacks
    version::Cuint                    = 1
...
"""
@kwdef struct type ProxyOptions
    version::Cuint             = 1
    proxytype::Cint
    url::Cstring
...
"""
@kwdef struct type FetchOptions
    version::Cuint                  = 1
...
"""
@kwdef struct type CloneOptions
    version::Cuint                      = 1
...
"""
@kwdef struct type DiffOptionsStruct
...
"""
@kwdef struct type MergeOptions
    version::Cuint                    = 1
    flags::Cint
...
"""
@kwdef struct type RebaseOptions
    version::Cuint                 = 1
    quiet::Cint                    = 1
    @static if LibGit2.VERSION >= v"0.24.0"
        inmemory::Cint
...
"""
@kwdef struct type StatusOptions
    version::Cuint           = 1
...
"""
mutable type GitSignature <: AbstractGitObject
...
mutable type UserPasswordCredentials <: AbstractCredentials
    user::String
    pass::String
...
mutable type SSHCredentials <: AbstractCredentials
    user::String
    pass::String
    pubkey::String
    prvkey::String
...
mutable type CachedCredentials <: AbstractCredentials
