...
struct type Returned <: ExecutionResult
    value
    data
end

struct type Threw <: ExecutionResult
    exception
    backtrace
end
...
"""
mutable type TestSetException <: Exception
    pass::Int
    fail::Int
    error::Int
    broken::Int
...
"""
struct type FallbackTestSet <: AbstractTestSet
end
fallback_testset = FallbackTestSet()

mutable type FallbackTestSetException <: Exception
    msg::String
end
...
"""
mutable type DefaultTestSet <: AbstractTestSet
...
"""
struct type GenericString <: AbstractString
