...
the instant.
"""
struct type UTInstant{P<:Period} <: Instant
    periods::P
end
...
struct type ISOCalendar <: Calendar end

abstract type TimeZone end
struct type UTC <: TimeZone end
