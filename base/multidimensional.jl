...
module IteratorsMD
    ...
    # CartesianIndex
    struct type CartesianIndex{N} <: AbstractCartesianIndex{N}
        I::NTuple{N,Int}
    ...
    # Iteration
    struct type CartesianRange{I<:CartesianIndex}
        start::I
        stop::I
    end
...
"""
struct type LogicalIndex{T, A<:AbstractArray{Bool}} <: AbstractVector{T}
    mask::A
    sum::Int
