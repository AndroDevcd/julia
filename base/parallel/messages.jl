...
struct type CallMsg{Mode} <: AbstractMsg
    f::Function
    args::Tuple
    kwargs::Array
end
struct type CallWaitMsg <: AbstractMsg
    f::Function
    args::Tuple
    kwargs::Array
end
struct type RemoteDoMsg <: AbstractMsg
    f::Function
    args::Tuple
    kwargs::Array
end
struct type ResultMsg <: AbstractMsg
    value::Any
end


# Worker initialization messages
struct type IdentifySocketMsg <: AbstractMsg
    from_pid::Int
end

struct type IdentifySocketAckMsg <: AbstractMsg
end

struct type JoinPGRPMsg <: AbstractMsg
    self_pid::Int
    other_workers::Array
    topology::Symbol
    enable_threaded_blas::Bool
end
struct type JoinCompleteMsg <: AbstractMsg
    cpu_cores::Int
    ospid::Int
end
