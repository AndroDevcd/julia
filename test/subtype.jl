...
mutable type ConcreteThing{T<:AbstractFloat,N} <: AbstractThing{T,N}
end
mutable type A11136 end
mutable type B11136 end
abstract type Foo11367 end

abstract type AbstractTriangular{T,S<:AbstractMatrix} <: AbstractMatrix{T} end
struct type UpperTriangular{T,S<:AbstractMatrix} <: AbstractTriangular{T,S} end
struct type UnitUpperTriangular{T,S<:AbstractMatrix} <: AbstractTriangular{T,S} end
...
struct type MyType12580{T}<:AbstractMyType12580{T} end
...
mutable type TwoParams{S,T}; x::S; y::T; end
