...
mutable type Stable{T,N}
    A::Array{T,N}
end
mutable type Unstable{T}
    A::Array{T}
end
...
struct type ReflectionExample{T<:AbstractFloat, N}
    x::Tuple{T, N}
end
...
struct type B20086{T,N} <: A20086{T,N} end
