...
try
    ...
    write(Foo_file,
          ...
          module $Foo_module
              ...
              struct type NominalPool{T, R <: Integer, V} <: CategoricalPool{T, R, V}
                  index::Vector{T}
                  invindex::Dict{T, R}
                  order::Vector{R}
                  ordered::Vector{T}
              ...
              struct type NominalValue{T, R <: Integer} <: CategoricalValue{T, R}
                  level::R
                  pool::NominalPool{T, R, NominalValue{T, R}}
              end
              struct type OrdinalValue{T, R <: Integer} <: CategoricalValue{T, R}
                  level::R
                  pool::NominalPool{T, R, NominalValue{T, R}}
              end
              ...
              # issue 18343
              struct type Pool18343{R, V}
                  valindex::Vector{V}
              end
              struct type Value18343{T, R}
