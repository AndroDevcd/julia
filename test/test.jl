...
mutable type NoThrowTestSet <: Base.Test.AbstractTestSet
    results::Vector
...
struct type CustomTestSet <: Base.Test.AbstractTestSet
...
struct type SillyArray <: AbstractArray{Float64,1} end
