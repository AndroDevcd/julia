...
mutable type Struct1
    x::Float32
    y::Float64
end
struct type Struct1I
    x::Float32
    y::Float64
end
...
mutable type Struct4
    x::Int32
    y::Int32
    z::Int32
end
struct type Struct4I
    x::Int32
    y::Int32
    z::Int32
end
...
mutable type Struct5
    x::Int32
    y::Int32
    z::Int32
    a::Int32
end
struct type Struct5I
    x::Int32
    y::Int32
    z::Int32
    a::Int32
...
mutable type Struct6
    x::Int64
    y::Int64
    z::Int64
end
struct type Struct6I
    x::Int64
    y::Int64
    z::Int64
end
...
mutable type Struct7
    x::Int64
    y::Cchar
end
struct type Struct7I
    x::Int64
    y::Cchar
end
...
mutable type Struct8
    x::Int32
    y::Cchar
end
struct type Struct8I
    x::Int32
    y::Cchar
end
...
mutable type Struct9
    x::Int32
    y::Int16
end
struct type Struct9I
    x::Int32
    y::Int16
end
...
mutable type Struct10
    x::Cchar
    y::Cchar
    z::Cchar
    a::Cchar
end
struct type Struct10I
    x::Cchar
    y::Cchar
    z::Cchar
    a::Cchar
...
mutable type Struct11
    x::Complex64
end
struct type Struct11I
    x::Complex64
end
...
mutable type Struct12
    x::Complex64
    y::Complex64
end
struct type Struct12I
    x::Complex64
    y::Complex64
end
...
mutable type Struct13
    x::Complex128
end
struct type Struct13I
    x::Complex128
end
...
mutable type Struct14
    x::Float32
    y::Float32
end
struct type Struct14I
    x::Float32
    y::Float32
end
...
mutable type Struct15
    x::Float64
    y::Float64
end
struct type Struct15I
    x::Float64
    y::Float64
end
...
mutable type Struct17
    a::Int8
    b::Int16
end
struct type Struct17I
    a::Int8
    b::Int16
end
...
mutable type Struct18
    a::Int8
    b::Int8
    c::Int8
end
struct type Struct18I
    a::Int8
    b::Int8
    c::Int8
end
...
mutable type Struct_Big
    x::Int
    y::Int
    z::Int8
end
struct type Struct_BigI
    x::Int
    y::Int
    z::Int8
end
...
mutable type Struct_huge3a
    cf::NTuple{3, Complex{Cfloat}}
    f7::Cfloat
    f8::Cfloat
end
mutable type Struct_huge3b
    cf::NTuple{7, Complex{Cfloat}}
    r8a::Cfloat
    r8b::Cfloat
end
mutable type Struct_huge3c
    cf::NTuple{7, Complex{Cfloat}}
    r8a::Cfloat
    r8b::Cfloat
    r9::Cfloat
end
mutable type Struct_huge4a
    r12::Complex{Cdouble}
    r34::Complex{Cdouble}
    r5::Complex{Cfloat}
    r67::Complex{Cdouble}
...
struct type Struct_AA64_1
    v1::Int32
    v2::Int128
end
struct type Struct_AA64_2
    v1::Float16
    v2::Float64
end

# This is a homogenious short vector aggregate
struct type Struct_AA64_3
    v1::VecReg{8,Int8}
    v2::VecReg{2,Float32}
end
# This is NOT a homogenious short vector aggregate
struct type Struct_AA64_4
    v2::VecReg{2,Float32}
    v1::VecReg{8,Int16}
end

mutable type Struct_huge1_ppc64
    m::Int64
    v::V4xF32
end

mutable type Struct_huge2_ppc64
    v1::V4xF32
    v2::V2xI32
end

mutable type Struct_huge3_ppc64
    v1::V4xF32
    f::NTuple{4,Float32}
end

mutable type Struct_huge4_ppc64
    v1::V2xF32
    v2::V2xF64
end

mutable type Struct_huge5_ppc64
    v1::NTuple{9,V4xF32}
end

mutable type Struct_huge6_ppc64
    v1::NTuple{8,V4xF32}
    v2::V4xF32
end

mutable type Struct_huge7_ppc64
    v1::VecReg{3,Int32}
    v2::VecReg{3,Int32}
end

mutable type Struct_huge1_ppc64_hva
    v1::NTuple{8,V4xF32}
end

mutable type Struct_huge2_ppc64_hva
    v1::NTuple{2,NTuple{2,V4xF32}}
end

mutable type Struct_huge3_ppc64_hva
    vf1::V4xF32
    vf2::Tuple{NTuple{2,V4xF32}}
end

mutable type Struct_huge4_ppc64_hva
    v1::V4xI32
    v2::V4xF32
end

mutable type Struct_huge5_ppc64_hva
    v1::V4xI32
    v2::V2xF64
end
