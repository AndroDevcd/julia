...
mutable type InstanceType11007 <: MethodType11007
end
let
...
struct type TypeWithIntParam{T <: Integer} end
let undefvar
...
struct type FunctionLike <: Function; end
let err_str,
